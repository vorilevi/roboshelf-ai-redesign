...
T1 verziótól való eltérések:
  ...
  - Dataset: vorilevi/roboshelf-gr1-push-v1 (HF)
...
Feltöltési mód:
  ...
  FONTOS — Kaggle path formátum (AI-6 known issue):
    ...
    dataset: /kaggle/input/datasets/leventevrss/roboshelf-gr1-push-v1/gr1_push_v1

API (sorrendben):
  vla.install_deps()
  import torch
  vla.clone_and_patch_repo()
  DS_ROOT = Path("/kaggle/input/datasets/leventevrss/roboshelf-gr1-push-v1/gr1_push_v1")
...
Referenciák:
  ...
  GR1 dataset:  vorilevi/roboshelf-gr1-push-v1  (996 ep, 99.6% scripted SR)
...
DEFAULT_DS_ROOT  = Path("/kaggle/input/datasets/leventevrss/roboshelf-gr1-push-v1/gr1_push_v1")
DEFAULT_CKPT_DIR = Path("/kaggle/working/unifolm_vla_gr1_roboshelf")
DEFAULT_HF_MODEL = "Qwen/Qwen2.5-VL-7B-Instruct"
HF_DATASET_ID    = "vorilevi/roboshelf-gr1-push-v1"
...
def download_dataset(
    ...
    Normál workflow: Kaggle-on add hozzá leventevrss/roboshelf-gr1-push-v1 datasetet.
    """
    from huggingface_hub import snapshot_download

    fallback_dir = Path("/kaggle/working/gr1_push_v1")
